...
const StyledButton: React.FC<StyledButtonProps> = ({
  ...
  const baseStyles =
    'font-semibold rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 transition-colors duration-150 ease-in-out inline-flex items-center justify-center';
